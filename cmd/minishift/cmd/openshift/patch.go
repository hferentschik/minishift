...
var patchCmd = &cobra.Command{
	Use:   "patch",
	Short: "Patches the specified OpenShift configuration resource.",
	Long:  "Patches the specified OpenShift configuration resource.",
	Run:   runPatch,
}

func init() {
	patchCmd.Flags().StringVar(&target, targetFlag, "master", "Target configuration to patch. Either 'master' or 'node'.")
	patchCmd.Flags().StringVar(&patch, patchFlag, "", "The patch to apply")
	OpenShiftConfigCmd.AddCommand(patchCmd)
}
