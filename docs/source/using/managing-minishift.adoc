...
For this you need to set an environment variable:

----
$ export MINISHIFT_ENABLE_EXPERIMENTAL=y
----

After this, when you would run a command like `minishift start -h` you will be shown some additional flags which have not yet been promoted for general use.

Be aware that these features can break or give a result you weren't expecting. We welcome your feedback when using them.
